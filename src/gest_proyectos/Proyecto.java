...
public class Proyecto extends com.matisse.reflect.MtObject {
    ...
    /* Index 'Indice_proyecto' */

    /** Index <code>Indice_proyecto</code> cache ID */
    private static int indice_proyectoIndexCID = com.matisse.MtDatabase.allocCID(new com.matisse.reflect.MtIndex.Loader("gest_proyectos.Indice_proyecto"));

    /**
     * Gets the <code>Indice_proyecto</code> index descriptor.
     * This method supports advanced MATISSE programming techniques such as
     * dynamically modifying the schema.
     * @param db a database
     * @return an index descriptor object
     */
    public static com.matisse.reflect.MtIndex getIndice_proyectoIndex(com.matisse.MtDatabase db) {
        return (com.matisse.reflect.MtIndex)db.getCachedObject(indice_proyectoIndexCID);
    }

    /**
     * Finds one <code>Proyecto</code> object in index <code>Indice_proyecto</code>.
     * @param db a database
     * @param nom_proy search parameter
     * @param f_inicio search parameter
     * @return the matching <code>Proyecto</code> object or <code>null</code> if none was found
     */
    public static Proyecto lookupIndice_proyecto(com.matisse.MtDatabase db, String nom_proy, java.util.GregorianCalendar f_inicio) {
        return (Proyecto)getIndice_proyectoIndex(db).lookup(new Object[] {nom_proy, calendarToShortList(f_inicio)}, getClass(db));
    }

    /**
     * Finds <code>Proyecto</code> objects in index <code>Indice_proyecto</code>.
     * @param db a database
     * @param nom_proy search parameter
     * @param f_inicio search parameter
     * @return the matching <code>Proyecto</code> objects or an empty array if none was found
     */
    public static Proyecto[] lookupObjectsIndice_proyecto(com.matisse.MtDatabase db, String nom_proy, java.util.GregorianCalendar f_inicio) {
        return (Proyecto[])getIndice_proyectoIndex(db).lookupObjects(new Object[] {nom_proy, calendarToShortList(f_inicio)}, getClass(db), Proyecto.class);
    }

    /**
     * Opens an iterator on index <code>Indice_proyecto</code> for class <code>Proyecto</code>.
     ...
     * @param <E> a MtObject class     * @param db a database
     * @param fromNom_proy search parameter
     * @param fromF_inicio search parameter
     * @param toNom_proy search parameter
     * @param toF_inicio search parameter
     * @return an object iterator
     */
    public static <E extends com.matisse.reflect.MtObject> com.matisse.MtObjectIterator<E> indice_proyectoIterator(com.matisse.MtDatabase db, String fromNom_proy, java.util.GregorianCalendar fromF_inicio, String toNom_proy, java.util.GregorianCalendar toF_inicio) {
        return getIndice_proyectoIndex(db).<E>iterator(new Object[] {fromNom_proy, calendarToShortList(fromF_inicio)}, new Object[] {toNom_proy, calendarToShortList(toF_inicio)}, getClass(db), com.matisse.reflect.MtIndex.DIRECT, com.matisse.MtDatabase.MAX_PREFETCHING, Proyecto.class);
    }
     ...
     * @return an object iterator
     */
    public static <E extends com.matisse.reflect.MtObject> com.matisse.MtObjectIterator<E> indice_proyectoIterator(com.matisse.MtDatabase db, String fromNom_proy, java.util.GregorianCalendar fromF_inicio, String toNom_proy, java.util.GregorianCalendar toF_inicio, com.matisse.reflect.MtClass filterClass, int direction, int numObjPerBuffer) {
        return getIndice_proyectoIndex(db).iterator(new Object[] {fromNom_proy, calendarToShortList(fromF_inicio)}, new Object[] {toNom_proy, calendarToShortList(toF_inicio)}, filterClass, direction, numObjPerBuffer, Proyecto.class);
    }
